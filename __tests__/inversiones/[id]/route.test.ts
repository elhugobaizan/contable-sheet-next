...
import { GET, PUT, DELETE } from '@/app/inversiones/[id]/route';
...
describe('Inversiones API - Route /inversiones/[id]', () => {
  const mockInversionId = '507f1f77bcf86cd799439011';
  ...
  describe('GET /inversiones/[id]', () => {
    it('debe obtener una inversión por ID exitosamente', async () => {
      ...
      const params = Promise.resolve({ id: mockInversionId });
      const response = await GET(new NextRequest('http://localhost:3000/api/inversiones/123'), { params });
  ...
  describe('PUT /inversiones/[id]', () => {
    it('debe actualizar una inversión exitosamente', async () => {
      ...
      const params = Promise.resolve({ id: mockInversionId });
      const req = new NextRequest('http://localhost:3000/api/inversiones/123', {
        method: 'PUT',
  ...
  describe('DELETE /inversiones/[id]', () => {
