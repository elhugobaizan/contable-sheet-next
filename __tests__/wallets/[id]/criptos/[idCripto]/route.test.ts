...
import { GET, PUT, DELETE } from '@/app/wallets/[id]/criptos/[idCripto]/route';
...
describe('Wallets API - Route /wallets/[id]/criptos/[idCripto]', () => {
  const mockWalletId = '507f1f77bcf86cd799439011';
  const mockCriptoId = '507f1f77bcf86cd799439020';
  ...
  describe('GET /wallets/[id]/criptos/[idCripto]', () => {
    it('debe obtener un cripto por ID exitosamente', async () => {
      ...
      const params = Promise.resolve({ id: mockWalletId, idCripto: mockCriptoId });
      const response = await GET(new NextRequest('http://localhost:3000/api/wallets/123/criptos/456'), { params });
  ...
  describe('PUT /wallets/[id]/criptos/[idCripto]', () => {
    it('debe actualizar un cripto exitosamente', async () => {
      ...
      const params = Promise.resolve({ id: mockWalletId, idCripto: mockCriptoId });
      const req = new NextRequest('http://localhost:3000/api/wallets/123/criptos/456', {
        method: 'PUT',
  ...
  describe('DELETE /wallets/[id]/criptos/[idCripto]', () => {
