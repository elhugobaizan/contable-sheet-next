...
import { GET, PUT, DELETE } from '@/app/wallets/[id]/inversiones/[idInversion]/route';
...
describe('Wallets API - Route /wallets/[id]/inversiones/[idInversion]', () => {
  ...
  describe('GET /wallets/[id]/inversiones/[idInversion]', () => {
    it('debe obtener una inversión por ID exitosamente', async () => {
      ...
      const params = Promise.resolve({ id: mockWalletId, idInversion: mockInversionId });
      const response = await GET(new NextRequest('http://localhost:3000/api/wallets/123/inversiones/456'), { params });
  ...
  describe('PUT /wallets/[id]/inversiones/[idInversion]', () => {
    it('debe actualizar una inversión exitosamente', async () => {
      ...
      const params = Promise.resolve({ id: mockWalletId, idInversion: mockInversionId });
      const req = new NextRequest('http://localhost:3000/api/wallets/123/inversiones/456', {
        method: 'PUT',
  ...
  describe('DELETE /wallets/[id]/inversiones/[idInversion]', () => {
